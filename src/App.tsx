           ...
           <>
             ...
             <section className="bg-purple-900 border-t border-purple-800 text-white rounded-t-3xl mt-12 py-16 px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                  <h2 className="text-3xl font-black mb-4">{isAr ? "لا تفوت أي عرض سري!" : "Never Miss a Secret Deal!"}</h2>
                  <p className="text-purple-100 font-medium text-lg mb-8 max-w-2xl mx-auto">
                    {isAr 
                      ? "اشترك في قائمتنا البريدية للحصول على أكواد خصم حصرية تصل إلى 90٪ قبل الجميع." 
                      : "Join our mailing list to get exclusive promo codes up to 90% off before anyone else."}
                  </p>
                  <form 
                    ...
                    onSubmit={(e) => { 
                      ...
                      fetch('/', {
                        ...
                        alert(isAr ? 'تم الاشتراك بنجاح!' : 'Successfully subscribed!');
